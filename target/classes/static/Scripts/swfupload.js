...
SWFUpload.prototype.startUpload = function (fileID) {
    ...
    try {
        ...
        if (!checkValIsUndefinedOrNull(authToken)) {
            this.addPostParam("authToken", authToken);
        }
    } catch (ex) {
...
SWFUpload.prototype.fileDialogStart = function (file) {
...
/* Called after the file dialog has closed and the selected files have been queued.
	You could call startUpload here if you want the queued files to begin uploading immediately. modify*/
